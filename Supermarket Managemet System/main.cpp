...
//Initializing Bread and Bakery sample data
    ...
    Products[3] = {3,"Sourdough ", "Bread and Bakery ", "Bread ",{6,7,21}, {10,9,21}, 250,"Loafes ",4,4.7 };
    ...
    Products[7] = {7,"Carrot Cake ", "Bread and Bakery ", "Bread ",{6,9,21}, {10,2,21},450,"Loafes ",20,4.1 };
...
//Initialising Pasta and rice sample data
    ...
    Products[17] = {17,"Spaghetti", "Pasta and Rice ", "Pasta ",{6,6,21}, {10,9,21}, 110," Killograms",30,4.9 };
    Products[18] = {18,"Brown Rice ", "Pasta and Rice ", "Rice ",{6,9,21}, {10,3,21}, 180,"Killograms ",30,4.7 };
...
//Initialising Dairy and meat sample data
    Products[20] = {20,"Beef ", "Dairy and Meat ", "Meat ",{6,1,21}, {10,9,21},150,"Killogram ",250,4.9 };
    Products[21] = {21,"Pork ", "Dairy and Meat ", "Meat ",{6,9,21}, {10,4,21},154,"Killogram ", 200,2.5 };
    ...
    Products[30] = {30,"Gouda ", "Dairy and Meat ", "Cheese ",{6,5,21}, {10,7,21},330,"Killogram ",380,5 };
